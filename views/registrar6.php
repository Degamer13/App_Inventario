...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Nuevo Vehiculo</h1>
...
</svg><h3>Registrar Vehiculo</h3></center>
  <form action="../php/registro6.php" method="POST">
   <div class="row g-2">
   <div class="mb-3">
  ...
  <Textarea type="text" class="form-control"   name="observacion"  required></Textarea>
</div>
<div class="col-md">
  <div class="mb-3">
  ...
  <input type="hidden" value="Almacenado" name="estatus">
  </div>
<br>
