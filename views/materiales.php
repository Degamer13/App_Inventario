    ...
    <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">LISTADO DE MATERIALES</h1>
                        <ol class="breadcrumb mb-4">
                         
                         <a href="registrar1.php" class="btn btn-success" >Registrar Entrada</a>
           </ol>
           <div class="card">
  <div class="card-body">
  <h3>Salida de Materiales</h3>
  <form action="../php/salida_materiales.php" method="POST">
           <div class="row g-3">
  ...
  <div class="col-sm-2">
    <input type="text" class="form-control" placeholder="Numero de Pack" name="numero_de_pack" required>
  </div>
  <div class="col-sm-2">
  ...
  <div class="col-sm-2">
    <input type="text" class="form-control" placeholder="Unidad de Medida" name="unidad_de_medida"  required>
  </div>
  <div class="col-sm-2">
...
while($fila = mysqli_fetch_array($result)){
    ...
    echo "<td>". $fila['numero_de_pack']. "</td>";
  ...
  echo "<td>". $fila['codigo']. "</td>";
    ...
    echo "<td>". $fila['unidad_de_medida']. "</td>";
    
      echo "<td><a href='actualizar_material.php?id=".$fila['id']."' class='btn btn-primary btn-raised btn-xs'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pen-fill' viewBox='0 0 16 16'>
      <path d='m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z'/>
    </svg></a></td>";
      echo "<td><a  class='btn btn-danger btn-raised btn-xs' href='../php/eliminar_materiales.php?id=".$fila['id']."'>
