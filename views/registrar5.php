...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Nuevo Sistema</h1>
...
</svg><h3>Registrar Sistema</h3></center>
  <form action="../php/registro5.php" method="POST">
   <div class="row g-2">
   <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" name="numero_pack" required>
