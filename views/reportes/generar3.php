...
<center><h3>LISTADO MAQUINARIAS FIJAS</h3></center>
   ...
   <td style="text-align: center;"><?php echo $fila['modelo'] ?></td>
...
$dompdf->render();
$dompdf->stream("reporte de maquinarias fijas.pdf", array("Attachment"=>false));
