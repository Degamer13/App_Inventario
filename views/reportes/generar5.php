...
<center><h3>LISTADO DE SISTEMAS</h3></center>
   ...
   <td style="text-align: center;"><?php echo $fila['numero_pack'] ?></td>
  ...
  <td style="text-align: center;"><?php echo $fila['responsable'] ?></td>
...
$dompdf->render();
$dompdf->stream("reporte de sistemas.pdf", array("Attachment"=>false));
