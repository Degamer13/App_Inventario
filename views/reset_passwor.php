...
<!-- Right Side Of Navbar -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 my-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 ">
                                    ...
                                    <div class="card-body">
                                        <form action="../php/cambio_passwor.php?id=<?=$id;?>" method="POST" onsubmit="return validarClave()">
                                            <br>
                                        <div class="group-material-login">
              <input type="password" class="material-login-control" name="passwordd" id='clave' required="" maxlength='15' minlength='8' >
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
              <label><i class="fas fa-lock"></i><i class="zmdi zmdi-lock"></i> &nbsp; Contraseña Nueva</label>
            </div><br>
            <div class="group-material-login">
              <input type="password" class="material-login-control"   name="passwordd" id='confirmacionClave'required="" maxlength='15' minlength='8'>
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
              <label><i class="fas fa-lock"></i><i class="zmdi zmdi-lock"></i> &nbsp; Confirmar Contraseña</label>
            </div>
  ...
  <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
        ...
        <script src="../js/validaClave.js"></script>
