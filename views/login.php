    ...
    <ul class="navbar-nav ms-auto">
        ...
        <div id="layoutAuthentication">
            <div id="layoutAuthentication_content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 my-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5  ">
                                    <div class="card-header"><h6 class="text-center font-weight-light "> <center><i class='fas fa-user-circle' style='font-size:50px;'></i><br><br>inicia sesión con tu cuenta</h6></div>
                                    <div class="card-body">
              ...
              <label><i class="fas fa-user fa-fw"></i> &nbsp; Usuario</label>
            </div><br>
            <div class="group-material-login">
              <input type="password" class="material-login-control"   name="passwordd" required="" >
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
              <label><i class="fas fa-lock"></i><i class="zmdi zmdi-lock"></i> &nbsp; Contraseña</label>
            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="password.php">Recuperar Contraseña?</a>
