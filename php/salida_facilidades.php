...
$stmt = $conexion->prepare("SELECT cantidad FROM facilidades WHERE 	serial_number = ?");
...
if ($producto && $producto['cantidad'] >= $cantidad) {
  ...
  $stmt = $conexion->prepare("UPDATE facilidades SET cantidad = ? WHERE serial_number = ?");
  ...
  $dompdf->loadHtml('<h1>Salida de Facilidades</h1><p>Descripción: '.$descripcion.'</p><p>Serial de Numero: '.$serial_number.'</p>
...
<p>Fecha: '.$fecha.'</p>');
   ...
   $file = 'salida_facilidades_' . $fechaHora . '.pdf';
   ...
   echo '<script>';
       ...
       echo '    Swal.fire({';
       echo '      icon: "success",';
       echo '      title: "Salida de facilidades correctamente",';
